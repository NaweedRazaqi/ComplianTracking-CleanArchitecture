...
namespace Clean.UI.Types
{
    public class BasePage : PageModel
    {
        ...
        public List<SelectListItem> ListOfFilteredComplain { get; set; }
        ...
        public List<SelectListItem> ListOfCases { get; set; }
        public List<SelectListItem> ListOfComplainType { get; set; }
        public List<SelectListItem> ListCaseStatus { get; set; }
